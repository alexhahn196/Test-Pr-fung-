...
- **Pillar → `pillar` in der Winner-DB:** P1 = `unusual_home` (bzw. `future_arch` bei futuristischen Konzepten), P2 = `luxury_room`, P3 = `pool` bei Pool-Endzustand, sonst `architecture`, P4 = `luxury_home`, P5 = `cozy_ambience` bzw. `location`. Zusätzlich `series_id`: `S01_unbuilt`, `S02_pick_one`, `S03_from_nothing`, `S04_night_stories`, `S05_wildcards`.
