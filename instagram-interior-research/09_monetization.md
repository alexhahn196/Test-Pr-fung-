...
5. **Kaufbarkeit geht unter den Top-Reels mit keinem nachweisbaren Reichweitenverlust einher.** Über alle Reels liegt „high" bei 0,98 (n=530) und „low" bei 0,97 (n=1.217), p=0,83. Bei KI-Reels liegt „high" bei 1,13 (n=85) und „low" bei 0,93 (n=397), p=0,78 (n. s.). Fantasy-/Impossible-Reels sind dagegen zu **0 % hoch kaufbar** (n=62). An dieser Stelle setzt der Hybrid-Test *„Impossible places, possible furniture"* an (5.3).
